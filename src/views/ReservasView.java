...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		this.setReservasController(new ReservasController());
	...
	private void salvarReserva() {
		try {
			...
			Reservas reserva = new Reservas(Date.valueOf(dataE), Date.valueOf(dataS), ReservasView.txtValor.getText(),
					ReservasView.txtFormaPagamento.getSelectedItem().toString());
